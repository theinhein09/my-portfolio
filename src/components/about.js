export function About() {
  return (
    ...
    >
      ...
      <section className="flex flex-grow items-center justify-center p-8 px-4">
        <div className="flex h-fit flex-grow flex-col items-center justify-center rounded-lg shadow-md ring-1 ring-black/5">
          <p className="max-w-prose py-5 text-justify md:py-14">
